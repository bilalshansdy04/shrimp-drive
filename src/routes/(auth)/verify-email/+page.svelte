	...
	<main class="z-10 w-full max-w-[400px]">
		...
		>
			...
			{#if form?.resendSuccess}
				<div
					class="mb-4 flex items-center gap-2 rounded-lg bg-[#00390f] px-4 py-2 text-sm font-medium text-[#73f382]"
				>
			...
			{#if form?.success}
				<div
					class="mb-4 flex flex-col items-center gap-2 rounded-lg bg-[#00390f] px-4 py-6 text-center text-sm font-medium text-[#73f382]"
				>
					...
					<a
						href="/login"
						class="mt-4 rounded-lg bg-[#73f382] px-6 py-2 font-bold text-[#00390f] transition-colors hover:bg-[#86fb94]"
					>
						Go to Login
					</a>
				</div>
			{:else}
				...
				>
					...
					<div class="mb-6 space-y-4">
						<div class="group relative">
							<label class="mb-1 block text-xs font-medium text-gray-400" for="otp"
								>6-Digit OTP Code</label
							>
							<div class="relative flex items-center">
								...
								<input
									name="otp"
									id="otp"
									class="w-full rounded-lg border border-[#2A3241] bg-[#0B0E14] py-3 pr-3 pl-10 text-center text-xl font-bold tracking-[0.2em] text-white transition-colors focus:border-[#FF6B4A] focus:outline-none"
									placeholder="000000"
									type="text"
									required
								/>
				...
				<div class="relative mt-6 flex items-center justify-center">
					...
					<div class="relative bg-[#151921] px-4 text-xs font-medium text-gray-400">
				...
				<div class="mt-6">
					...
					>
						...
						<button
							...
							class="flex w-full items-center justify-center gap-2 rounded-lg border border-[#2A3241] bg-[#0B0E14] px-6 py-3 text-sm font-medium text-white transition-colors hover:border-[#FF6B4A] hover:text-[#FF6B4A] disabled:opacity-50"
						>
