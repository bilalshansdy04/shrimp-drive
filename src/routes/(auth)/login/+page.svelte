	...
	<main class="z-10 w-full max-w-[400px]">
		...
		>
			...
			<div class="mt-6">
				<a
					href="/login/google"
					class="flex w-full items-center justify-center gap-3 rounded-lg border border-[#2A3241] bg-[#0B0E14] px-6 py-3 text-sm font-medium text-white transition-colors hover:border-[#FF6B4A] hover:text-[#FF6B4A]"
				>
