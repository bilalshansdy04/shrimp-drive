...
export const users = sqliteTable('users', {
	...
	telegramNodeId: text('telegram_node_id').references(() => telegramNodes.id, {
		onDelete: 'set null'
	}),
	encryptionMode: text('encryption_mode'), // 'locked_on' | 'locked_off' | 'flexible'
	encryptionKeyId: text('encryption_key_id').references(() => encryptionKeys.id, {
		onDelete: 'set null'
	}),
...
export const invitationCodes = sqliteTable('invitation_codes', {
	...
	assignedNodeId: text('assigned_node_id').references(() => telegramNodes.id, {
		onDelete: 'set null'
	}),
